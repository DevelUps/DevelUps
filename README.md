...
![Katalon Studio](https://img.shields.io/badge/Katalon%20Studio-FF6C37?style=for-the-badge&logo=katalon&logoColor=white)
...
- 📘 **Software Development Engineering** - Politécnico Grancolombiano 
- 📘 **Technology in ADSI** - SENA 
- 📘 **Technical Degree** - Universidad Autónoma del Caribe 

## 🏆 ![Udemy](https://img.shields.io/badge/Udemy-A435F0?style=for-the-badge&logo=Udemy&logoColor=white)

<ul>
  <li>🏅 <strong>Master: Katalon Studio Test Automation - Udemy</strong></li>
  <li>🏅 <strong>Unit Testing with xUnit on .NET - Udemy</strong></li>
  <li>🏅 <strong>API Testing with Postman - Udemy</strong></li>
  <li>🏅 <strong>Scrum Foundation Professional Certificate SFPC™ - CertiProf</strong></li>
  <li>🏅 <strong>Java from Zero to Expert - Udemy</strong></li>
  <li>🏅 <strong>Scrum Fundamentals Certified SFC™ - VMEdu Inc.</strong></li>
  <li>🏅 <strong>JR. QA TRAINING - VSI Global, LLC</strong></li>
  <li>🏅 <strong>JAVA - Servicio Nacional de Aprendizaje (SENA)</strong></li>
  <li>🏅 <strong>ERP Services and Implementation - Servicio Nacional de Aprendizaje (SENA)</strong></li>
  <li>🏅 <strong>HTML and JavaScript - Servicio Nacional de Aprendizaje (SENA)</strong></li>
  <li>🏅 <strong>Mobile Device Programming - Servicio Nacional de Aprendizaje (SENA)</strong></li>
  <li>🏅 <strong>Web Assistant - Fundación Carlos Slim</strong></li>
  <li>🏅 <strong>Finder - Fundación Carlos Slim</strong></li>
  <li>🏅 <strong>POO (Object-Oriented Programming) - Fundación Carlos Slim</strong></li>
  <li>🏅 <strong>Tester - Fundación Carlos Slim</strong></li>
</ul>
